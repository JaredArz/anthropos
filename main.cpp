...
int sdl_init(void){
    ...
    menu_font = TTF_OpenFont( "Lazy.ttf",28);
    if (menu_font == NULL){
...
int main( int argc, char* args[] ){
    ...
    menu_txtr   = load_texture_from_bmp("./reading/background.bmp");
    player_txtr = load_texture_from_bmp("./reading/eye.bmp");
    boss_txtr   = load_texture_from_bmp("./reading/boss.bmp");
    bullet_txtr = load_texture_from_bmp("./reading/proj.bmp");
    game_over_txtr = load_texture_from_bmp("./reading/game_over.bmp");
    laser_txtrs[0] = load_texture_from_bmp("./reading/laser_one.bmp");
    laser_txtrs[1] = load_texture_from_bmp("./reading/laser_two.bmp"); 
